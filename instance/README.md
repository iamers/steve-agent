...
a thin wrapper under `~/.hermes/scripts/` and the scheduler entry in the Hermes
cron database are instance activation details. `pr-watch.sh`,
`backup-kanban.sh`, and `merge-gate-scan.sh` follow this model.
